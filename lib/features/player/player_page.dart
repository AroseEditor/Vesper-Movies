      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: Center(
                child: preload.active
                    ? _PreloadPanel(
                        preload: preload,
                        onSkip: () {
                          unawaited(controller.skipPreload());
                          onInteract();
                        },
                      )
                    : buffering
...
class _PreloadPanel extends StatelessWidget {
  const _PreloadPanel({required this.preload, required this.onSkip});
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: preload.ratio == 0 ? null : preload.ratio,
              minHeight: 5,
