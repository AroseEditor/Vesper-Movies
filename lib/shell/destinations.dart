...
enum AppDestination {
  ...
  categories('/categories', 'Categories', VesperIcons.categories, VesperIcons.categoriesOutline),
  ...
  downloads('/downloads', 'Downloads', VesperIcons.downloads, VesperIcons.downloadsOutline);
